...
/**
 * 重写SpringSecurity AbstractUserDetailsAuthenticationProvider，用来控制第三方账号登陆，
 * 第三方账号登录可以使用MD5后密码进行登录 ,MD5密码登录使用Globals.THIRD_ACCOUNT_LOGIN作为前缀标识，
 * 系统自动不进行处理
 * @author xiaoxiong
 * 
 */
public class ZmpartyAuthenticationProvider extends
