...
public class ZmpartySecurityExceptionFilter extends SpringSecurityFilter implements
		InitializingBean {
	...
	public ZmpartySecurityExceptionFilter() {
		this.accessDeniedHandler = new ZmpartyAccessDeniedHandlerImpl();
