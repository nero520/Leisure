package com.leisure.core.constant;
...
public class Globals {
	...
	public final static String DEFAULT_TABLE_SUFFIX = "zmparty_";// 默认表前缀名
	public final static String THIRD_ACCOUNT_LOGIN = "zmparty_thid_login_";// 第三方账号登录的前缀
	
	public final static String DEFAULT_SYSTEM_TITLE = "zmparty多用户系统";// 系统默认名称
	public final static boolean SSO_SIGN = true;// 是否允许单点登录
	
	public final static String DEFAULT_WBESITE_NAME = "zmparty";// 软件名称
	...
	public final static String SYSTEM_MANAGE_PAGE_PATH = "WEB-INF/templates/zh_cn/admin/";// 默认系统后台页面路径为
	public final static String SYSTEM_FORNT_PAGE_PATH = "WEB-INF/templates/zh_cn/user/";// 默认系统页面前台路径
	...
	public final static String DEFAULT_BIND_DOMAIN_CODE = "F10D95473392E4850ACB507A25523C1597B9DCE99C5934CD589CFE4E769668CB";// 绑定的域名加密字符串
}