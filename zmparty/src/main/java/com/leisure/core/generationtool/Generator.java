package com.leisure.core.generationtool;
...
import com.leisure.core.annotation.Title;

public class Generator {

	protected String templateDir = "\\src\\main\\webapp\\templates\\";
	protected String resultDir = "\\src\\main\\webapp\\result\\";
...
//		htmlMapping.put("tag_list.html", bealower + "_list.html");
		...
		htmlMapping.put("tagEdit.html", bealower + "_edit.html");
		htmlMapping.put("tagList.html", bealower + "_list.html");
